...
{
    public unsafe class RevoLayerYeltYearArrayUnmanagedUnsafe : IBenchmarkYelt, IDisposable
    {
        ...
        public RevoLayerYeltYearArrayUnmanagedUnsafe(in int lossAnalysisId, in int layerId, in IEnumerable<RevoLayerYeltEntry> yelt)
        {
            _disposed = false;
