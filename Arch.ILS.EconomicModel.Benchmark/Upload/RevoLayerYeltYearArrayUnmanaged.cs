...
{
    public unsafe class RevoLayerYeltYearArrayUnmanaged : IBenchmarkYelt, IDisposable
    {
        ...
        public RevoLayerYeltYearArrayUnmanaged(in int lossAnalysisId, in int layerId, in IEnumerable<RevoLayerYeltEntry> yelt)
        {
            _disposed = false;
