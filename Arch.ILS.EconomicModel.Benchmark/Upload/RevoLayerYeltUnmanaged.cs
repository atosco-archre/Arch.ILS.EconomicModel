...
{
    public unsafe class RevoLayerYeltUnmanaged : IBenchmarkYelt, IDisposable
    {
        ...
        public RevoLayerYeltUnmanaged(in int lossAnalysisId, in int layerId, in IEnumerable<RevoLayerYeltEntry> yelt)
        {
            _disposed = false;
