...
namespace Arch.ILS.EconomicModel.Benchmark
{
    ...
    public unsafe struct DynamicDirectory3<TKey, TValue>
        where TKey : struct, IEquatable<TKey>
    {
        ...
        public DynamicDirectory3(int fixedCapacity)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveOptimization)]
        public Entry GetNextRef(ref readonly TKey key, ref readonly Entry entry)
        {
            Entry[] entries = _entries;
            uint hashCode = (uint)key.GetHashCode(); // Constrained call
