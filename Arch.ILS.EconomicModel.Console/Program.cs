...
namespace Arch.ILS.EconomicModel.Console
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            YeltPartitioner yeltPartitioner = new YeltPartitioner(new Range[] { new Range(2, 2) }, layerYelt);
            //yeltPartitioner.TryGetCurrentPartition(out var yeltDayPartition);
            YeltPartitionLinkedListReader yeltPartitionLinkedListReader = YeltPartitionLinkedListReader.Initialise(yeltPartitioner);            
